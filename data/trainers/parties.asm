...
Rival1Data:
	...
	db 5, CHARMANDER, 0
; Route 22
	db $FF, 8, PIDGEY, 7, SQUIRTLE, 0
	db $FF, 8, PIDGEY, 7, BULBASAUR, 0
	db $FF, 8, PIDGEY, 7, CHARMANDER, 0
; Cerulean City
	db $FF, 18, PIDGEOTTO, 16, ODDISH, 19, WARTORTLE, 0
	db $FF, 18, PIDGEOTTO, 16, ODDISH, 19, IVYSAUR, 0
	db $FF, 18, PIDGEOTTO, 16, ODDISH, 19, CHARMELEON, 0

ProfOakData:
; Unused
	db $FF, 72, TAUROS, 71, VICTREEBEL, 73, NINETALES, 74, BLASTOISE, 73, DRAGONITE, 75, NIDOKING, 0
	db $FF, 72, TAUROS, 71, NINETALES, 73, TENTACRUEL, 74, VENUSAUR, 73, DRAGONITE, 75, NIDOKING, 0
	db $FF, 72, TAUROS, 71, TENTACRUEL, 73, VICTREEBEL, 74, CHARIZARD, 73, DRAGONITE, 75, NIDOKING, 0
...
Rival2Data:
; SS Anne 2F
	db $FF, 20, SANDSHREW, 23, RATICATE, 22, KADABRA, 24, WARTORTLE, 0
	db $FF, 20, SANDSHREW, 23, RATICATE, 22, KADABRA, 24, IVYSAUR, 0
	db $FF, 20, SANDSHREW, 23, RATICATE, 22, KADABRA, 24, CHARMELEON, 0
; Pokémon Tower 2F
	db $FF, 34, FEAROW, 33, SCYTHER, 32, VULPIX, 33, KADABRA, 35, WARTORTLE, 0
	db $FF, 34, FEAROW, 33, GYARADOS, 32, GROWLITHE, 33, KADABRA, 35, IVYSAUR, 0
	db $FF, 34, FEAROW, 33, EXEGGCUTE, 32, SHELLDER, 33, KADABRA, 35, CHARMELEON, 0
; Silph Co. 7F
	db $FF, 43, PORYGON, 44, PRIMEAPE, 41, VICTREEBEL, 42, ALAKAZAM, 45, BLASTOISE, 0
	db $FF, 43, DODRIO, 44, RAICHU, 41, CLOYSTER, 42, ALAKAZAM, 45, VENUSAUR, 0
	db $FF, 43, PARASECT, 44, GYARADOS, 41, RHYDON, 42, ALAKAZAM, 45, CHARIZARD, 0
; Route 22
	db $FF, 54, DODRIO, 50, VICTREEBEL, 53, NINETALES, 51, MACHAMP, 52, ALAKAZAM, 55, BLASTOISE, 0
	db $FF, 54, FEAROW, 50, SANDSLASH, 53, GOLDUCK, 51, MAGNETON, 52, ALAKAZAM, 55, VENUSAUR, 0
	db $FF, 54, PIDGEOT, 50, GYARADOS, 53, EXEGGUTOR, 51, MAROWAK, 52, ALAKAZAM, 55, CHARIZARD, 0

Rival3Data:
	db $FF, 64, PIDGEOT, 63, ALAKAZAM, 61, MACHAMP, 62, NINETALES, 63, SCYTHER, 65, BLASTOISE, 0
	db $FF, 64, FEAROW, 63, ALAKAZAM, 61, SANDSLASH, 62, CLOYSTER, 63, MAGNETON, 65, VENUSAUR, 0
	db $FF, 64, DODRIO, 63, ALAKAZAM, 61, RHYDON, 62, EXEGGUTOR, 63, GYARADOS, 65, CHARIZARD, 0
